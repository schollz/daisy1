 ...
 * so [1 + LOGGER_BUFFER] buffer would contain LOGGER_BUFFER meaningful
 * characters
 */
...
void ProfilePrint(const char* class_caption, const char* func_caption) {
  ...
  hw.PrintLine("%s - %s (  empty string):" FLT_FMT3 " us/call", class_caption,
               func_caption, FLT_VAR3(print_0));
  hw.PrintLine(
      "%s - %s (   text string):" FLT_FMT3 " us/call +" FLT_FMT3 " us/char",
      class_caption, func_caption, FLT_VAR3(intercept), FLT_VAR3(slope));
  hw.PrintLine("%s - %s ( integer value):" FLT_FMT3 " us/call", class_caption,
               func_caption, FLT_VAR3(print_d));
  hw.PrintLine("%s - %s (unsigned value):" FLT_FMT3 " us/call", class_caption,
               func_caption, FLT_VAR3(print_u));
  hw.PrintLine("%s - %s ( float.3 value):" FLT_FMT3 " us/call", class_caption,
               func_caption, FLT_VAR3(print_f));
  hw.PrintLine("%s - %s (FLT_VAR1 value):" FLT_FMT3 " us/call", class_caption,
               func_caption, FLT_VAR3(print_F1));
  hw.PrintLine("%s - %s (FLT_VAR2 value):" FLT_FMT3 " us/call", class_caption,
               func_caption, FLT_VAR3(print_F2));
  hw.PrintLine("%s - %s (FLT_VAR3 value):" FLT_FMT3 " us/call", class_caption,
               func_caption, FLT_VAR3(print_F3));
  hw.PrintLine("%s - %s (FLT_VAR4 value):" FLT_FMT3 " us/call", class_caption,
               func_caption, FLT_VAR3(print_F4));
}
...
void VerifyFloats() {
  ...
  for (float f = -100.0; f < 100.0; f += 0.001) {
    ...
    /* verify down to the least significant digit, which is off because of
     * truncation */
...
int main(void) {
   ...
   * Note that this would require the linker to include the whole object with
   * own buffers!
   */
...
1. This should really
overflow...................................................................................................$$
2. This should be treated as
overflow............................................................................................$$
3. This should be safe for
Print()................................................................................................
4. This should be safe for
Print()...............................................................................................
5. This should be safe for Print() and
PrintLine()..............................................................................
