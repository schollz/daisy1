...
class mydsp : public dsp {
 ...
 public:
  ...
  virtual void buildUserInterface(UI* ui_interface) {
    ...
    ui_interface->addHorizontalSlider("Predelay", &fHslider3, FAUSTFLOAT(0.0f),
    ...
    ui_interface->addHorizontalSlider("Decay", &fHslider0, FAUSTFLOAT(5e+01f),
  ...
  virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs,
    ...
    for (vindex = 0; vindex <= (count - 32); vindex = vindex + 32) {
      ...
      for (int i = 0; i < vsize; i = i + 1) {
        output0[i] =
            FAUSTFLOAT(0.6f * (fRec2[(i + fRec2_idx - iConst28) & 32767] +
      ...
      for (int i = 0; i < vsize; i = i + 1) {
        output1[i] =
            FAUSTFLOAT(0.6f * (fRec5[(i + fRec5_idx - iConst35) & 32767] +
