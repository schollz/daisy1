...
class KorgLPF {
 ...
 public:
  ...
  //     m->declare("vaeffects.lib/korg35LPF:license", "MIT-style STK-4.3
  //     license"); m->declare("vaeffects.lib/name", "Faust Analog Filter Effect
  //     Library"); m->declare("vaeffects.lib/version", "1.2.1");
  //   }
